...
export const regulatoryActions: RegulatoryAction[] = [
  ...
  },
  {
    ...
    risk: 'R1 in risk matrix — policy reversal. Mitigation: get written scope confirmation from HSITP policy team.',
  },
  {
    id: 'REG-04',
    jurisdiction: 'Hong Kong',
    law: 'HSITP IGNITE Programme',
    action: 'IGNITE@HSITP Programme awarded (HK$6M)',
    owner: 'MetaBee',
    deadline: '2026 Q3',
    dependencies: ['REG-01'],
    status: 'completed',
    phase: 1,
    category: 'grant',
    details: 'IGNITE@HSITP already awarded to MetaBee (HK$6M over 4 years for Life & Health Technology). Funding distributed in equal instalments based on milestone assessments every 6 months. Free office space and shared facilities included during programme period.',
    risk: 'HIGH probability — competitive. Mitigation: angel round HK$2M as runway bridge.',
  },
  {
    id: 'REG-05',
    jurisdiction: 'Macau',
